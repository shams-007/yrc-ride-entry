...
// Branch coordinates scaled directly to fit your exact 124x125 space
    ...
    >
      ...
      <div className="relative flex h-full w-full flex-col">
        <div className="relative flex-1">
          {/* Matches the coordinate bounds of your exact SVG path */}
          <svg
            viewBox="0.22 -0.456 124 125"
            width="100%"
            height="100%"
          ...
          >
            ...
            <path
              ...
              strokeWidth={0.5} // Proportionately sized for the 124x125 view
              strokeLinejoin="round"
              style={{
                filter: "drop-shadow(0 0 2.5px rgba(0, 71, 204, 0.75))"
              }}
            />
