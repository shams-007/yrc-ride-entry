...
// Geographically accurate, smooth outline of Bangladesh 
// constructed using absolute Bezier coordinates to prevent any skewing or loop glitches.
const BD_OUTLINE =
  "M 210,30 " +
...
// Main branch coordinates aligned with the upright map space
