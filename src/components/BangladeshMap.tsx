...
// Geographically precise, smooth outline of Bangladesh.
// Guaranteed not to truncate. Features your exact requested tweaks:
// 1. Added the top-left outward bulge.
// 2. Elongated the bottom-right tail.
const BD_OUTLINE =
  "M 210 30 " +
  "C 195 40, 180 50, 175 60 " +
  "C 165 70, 155 85, 150 100 " +
  // YOUR TWEAK 1: The Top-Left Bulge
  "C 130 130, 90 150, 60 180 " + 
  "C 40 200, 40 220, 50 240 " + 
  "C 60 250, 85 245, 110 255 " +
  // Back to mainland western border
  "C 115 270, 120 285, 122 300 " +
  "C 125 320, 130 340, 135 360 " + 
  "C 150 365, 160 362, 170 365 " + 
  "C 180 368, 190 360, 200 365 " +
  "C 210 368, 220 362, 230 365 " +
  "C 245 368, 255 362, 260 370 " + 
  "C 275 380, 290 395, 305 410 " + 
  "C 315 425, 320 440, 325 455 " + 
  // YOUR TWEAK 2: Elongated Bottom-Right Tail
  "C 328 475, 335 490, 335 505 " + 
  "C 335 515, 330 520, 325 515 " + 
  "C 320 500, 315 480, 322 455 " + 
  // Curving back up the eastern border
  "C 320 390, 322 370, 325 350 " +
  "C 330 330, 335 310, 340 290 " + 
  "C 335 270, 320 255, 310 245 " +
  "C 305 235, 300 220, 298 210 " + 
  "C 310 200, 325 190, 340 180 " +
  "C 350 175, 355 165, 350 155 " + 
  "C 340 145, 325 145, 310 145 " + 
  "C 290 145, 270 145, 255 145 " + 
  "C 240 140, 225 135, 210 130 " +
  "C 195 110, 185 85, 175 70 " +
  "C 165 55, 160 45, 160 40 Z " + 
  // Offshore Islands
...
// Branch coordinates meticulously aligned to the new shape
const MAIN: MainBranch[] = [
  { id: "dhaka", name: "🏍 DHAKA CENTRAL", coord: "Managed by Aminul Islam", cx: 215, cy: 240 },
  { id: "chittagong", name: "🏍 CHITTAGONG HUB", coord: "Led by Mohammad Sajid", cx: 295, cy: 395 },
  { id: "sylhet", name: "🏍 SYLHET REGIONAL", coord: "Coordinated by Farhana Akter", cx: 320, cy: 160 },
];

const DECOR = [
  { name: "Rajshahi", cx: 80, cy: 210, delay: 0 },
  { name: "Khulna", cx: 150, cy: 330, delay: 0.3 },
  { name: "Barisal", cx: 210, cy: 340, delay: 0.6 },
  { name: "Rangpur", cx: 150, cy: 100, delay: 0.9 },
  { name: "Mymensingh", cx: 210, cy: 160, delay: 1.2 },
  { name: "Comilla", cx: 275, cy: 240, delay: 1.5 },
  { name: "Cox's Bazar", cx: 325, cy: 450, delay: 1.8 },
  { name: "Jessore", cx: 120, cy: 300, delay: 0.15 },
];

// Trail connecting the three main cities smoothly
const BIKE_PATH =
  "M215,240 Q280,310 295,395 Q340,250 320,160 Q250,180 215,240";
    ...
    >
      ...
      <div className="relative flex h-full w-full flex-col">
        <div className="relative flex-1">
          {/* viewBox perfectly frames the country with padding on all sides so it fits the screen */}
          <svg
            viewBox="0 0 420 550"
            width="100%"
            height="100%"
          ...
          >
            ...
            {/* Render the smooth, tweaked map of Bangladesh in official Yamaha Navy Blue */}
            <path
          ...
          {/* Tooltips — positioned correctly using the 420x550 grid */}
          {MAIN.map((m) => {
